...
public class ExampleSegmentColor {
    ...
    public static void main( String args[] ) {
        ...
        BufferedImage image = UtilImageIO.loadImage("Pipe - Resized.png");
        ...
        showSelectedColor("Pipe Green",image,2.7f,1.0f);
        showSelectedColor("Pipe Pink",image,6.0f,0.65f);
    }
}